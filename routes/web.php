...
// Update bagian routes untuk cart di web.php
...
// Cart routes - PENTING: Jangan taruh di dalam middleware auth, biarkan controller yang handle
...
// Review routes dan Cart management lainnya (requires authentication)
Route::middleware(['auth'])->group(function () {
    ...
    // Cart management - yang memerlukan auth
